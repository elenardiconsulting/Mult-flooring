...
export const PROJECTS: Project[] = [
  ...
  {
    id: 'project-02',
    name: 'Hardwood Project 02',
    city: 'Massachusetts',
    type: 'Residential',
    material: 'Hardwood Installation',
    image: '/projects/project-02.jpg',
  },
  {
    id: 'project-05',
    name: 'Hardwood Project 05',
    city: 'Massachusetts',
    type: 'Residential',
    material: 'Hardwood Installation',
