        ...
        >
          ...
          >
            {TESTIMONIALS.map((t, i) => (
              <article
                key={i}
                className="flex-shrink-0 bg-[var(--color-bg-surface)] border border-[var(--color-border)] max-md:w-[85vw] md:w-[calc((100%-80px)/3)] md:aspect-[4/5] lg:aspect-square flex flex-col"
                style={{
